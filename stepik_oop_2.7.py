...
свойство(@property) геттер dollars, которое возвращает количество имеющихся долларов;
...
В случае, если в сеттер передано число,
...
Bill = Money(101, 99) # билл - экземпляр класса Money
